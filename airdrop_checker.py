...
if st.session_state.airdrops:
    ...
    edited_df = st.data_editor(
        ...
        column_config={
            ...
            "Expected Date": st.column_config.DateColumn("Expected Date", format="YYYY-MM-DD"),
            ...
            "Last Activity": st.column_config.DateColumn("Last Activity", format="YYYY-MM-DD"),
    ...
    if not edited_df.equals(df):
        st.session_state.airdrops = edited_df.to_dict('records')
else:
